...
public class Main {
    public static void main(String[] args) {
      Car car1 =new Car("Лада","Гранта",1.6, Car.BodyType.sedan);
        Car car2 =new Car("Волга","Siber",2.6, Car.BodyType.universal);
        Car car3 =new Car("УАЗ","Патриот",3.6, Car.BodyType.coupe);
        Car car4 =new Car("Ока","Гном",1.0, null);
        ...
        Truck truck1=new Truck("КАМАЗ","Компас",3.2, Truck.Carrying.n1);
        Truck truck2=new Truck("ГАЗ","НЕКСТ",2.7,Truck.Carrying.n2);
        Truck truck3=new Truck("НЕФАЗ","4514",3.2, Truck.Carrying.n3);
        Truck truck4=new Truck("Урал","4320",3.2,Truck.Carrying.n1);
